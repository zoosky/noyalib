...
Measured 2026-09-22T13:31:37Z on `aarch64-apple-darwin`, rustc 1.98.0 (88d9e12ae 2026-08-18). Rubric executed: 92%.

| Repo | Metric | Measured | Score | Probe |
|---|---|---|---:|---|
| `noyalib` | tests | 6450 passed / 0 failed | 1.00 | `cargo test --workspace --locked` |
...
| `noyalib` | crates_io_current | tree 0.0.51 / crates.io 0.0.50 | 0.00 | `crates.io/api/v1/crates/noyalib .max_stable_version` |
...
| `noya-cli` | crates_io_current | tree 0.0.51 / crates.io 0.0.50 | 0.00 | `crates.io/api/v1/crates/noya-cli .max_stable_version` |
...
| `noyalib-lsp` | crates_io_current | tree 0.0.51 / crates.io 0.0.50 | 0.00 | `crates.io/api/v1/crates/noyalib-lsp .max_stable_version` |
...
| `noyalib-mcp` | crates_io_current | tree 0.0.51 / crates.io 0.0.50 | 0.00 | `crates.io/api/v1/crates/noyalib-mcp .max_stable_version` |
...
| `noyalib-wasm` | crates_io_current | tree 0.0.51 / crates.io 0.0.50 | 0.00 | `crates.io/api/v1/crates/noyalib-wasm .max_stable_version` |
...
| `noyalib-serde-yaml` | crates_io_current | tree 0.0.51 / crates.io 0.0.50 | 0.00 | `crates.io/api/v1/crates/noyalib-serde-yaml .max_stable_version` |
...
| `ecosystem` | version_lockstep | core 0.0.51 not tagged yet | n/a | `git tag -l v0.0.51 in noyalib (pending release; satellites pin only published versions)` |
