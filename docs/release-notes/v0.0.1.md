...
[`POLICIES.md`](../../docs/POLICIES.md) "no pre-emptive phasing"
guidance).
...
[`docs/MIGRATION.md`](../../docs/MIGRATION.md) and the eight per-crate
files alongside it.
...
- [`docs/POLICIES.md`](../../docs/POLICIES.md) — engineering posture
  (MSRV / SemVer / security / performance / concurrency / etc).
- [`docs/MIGRATION.md`](../../docs/MIGRATION.md) — umbrella migration
  index linking the eight per-crate migration guides.
- [`docs/BENCHMARKS.md`](../../docs/BENCHMARKS.md) — full benchmark
  tables.
